...
function startSpecialDayCountdown() {
    ...
    const defaultBannerUrl = "https://img2.pixhost.to/images/7203/715352466_alip-1776279666850.jpg";
...
// ----------------------------------------------------
// FUNGSI DETEKSI OTOMATIS (AMPLOP Jeeyhosting KAGET)
// ----------------------------------------------------
    ...
    try {
        ...
        if (data.success) {
            headerHtml = `
                ...
                <div style="font-size:14px; color:#555; margin-top:10px;">Selamat! Kamu mendapat Jeeyhosting Kaget dari <b>${data.creator}</b></div>
            ...
            headerHtml = `
                <div style="font-size:60px; margin-top:-10px;">😭</div>
                <div style="font-size:14px; color:#555; margin-top:10px;">${data.creator ? 'Jeeyhosting Kaget dari <b>' + data.creator + '</b>' : ''}</div>
            ...
            Swal.fire({
                html: `
                    <div style="padding:20px 10px;">
                        ...
                        <h2 style="color:#e74c3c; font-weight:900; margin:0; font-size:24px; text-transform:uppercase; letter-spacing:1px;">Jeeyhosting Kaget</h2>
